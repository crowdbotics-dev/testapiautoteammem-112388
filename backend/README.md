...
## Project Structure
    ...
    ├── testapiautoteammem_112388  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_112388`
...
2. Clone this repo and `cd testapiautoteammem_112388`
